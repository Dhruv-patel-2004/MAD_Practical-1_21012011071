...
fun main() {
    val firstMatrixData = arrayOf(doubleArrayOf(5.0, 7.0, 4.0), doubleArrayOf(2.0, 8.0, 3.0))
    val secondMatrixData = arrayOf(doubleArrayOf(-4.0, 2.0, 4.0), doubleArrayOf(-7.0, 0.0, 2.0), doubleArrayOf(5.0, 1.0, 6.0))
    val secondMatrix1Data = arrayOf(doubleArrayOf(-1.0, 0.0, 6.0), doubleArrayOf(0.0, 5.0, 8.0), doubleArrayOf(8.0, 3.0, 7.0))
